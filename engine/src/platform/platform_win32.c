#include "platform.h"
    ...
    b8 platform_startup(platform_state* plat_state, const char* application_name, u16 x, u16 y, u16 width, u16 heigth)
    {
        ...
        window_heigth += border_rect.bottom - border_rect.top;

        HWND handle = CreateWindowExA(window_ex_style, "moj_window_class", application_name,
            window_style, window_x, window_y, window_width, window_heigth, 0, 0, i_state->h_instance, 0);
